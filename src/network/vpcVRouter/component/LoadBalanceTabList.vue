  ...
  <div class="container">
    <div class="detail-page-toolbar">
      <div class="detail-page-toolbar-left">
        <span class="detail-page-toolbar-title" style="margin-right: 30px;">{{$t('common.loadbalancer') + $t('common.colon')}}</span>
        <help-trigger name="portForwarding" style="position: absolute;top: 5px;right: 5px;left: 85px;"/>
...
<script>
  ...
  import LoadBalancerList from 'src/network/loadBalancer/List';
  import { formatDatetime } from 'src/utils/utils';
  import WindowBase from 'src/windows/Window';
  import PageBase from 'src/windows/PageBase';

  export default {
    name: "LoadBalanceTabList",

    mixins: [LoadBalancerList, PageBase, WindowBase, MultiSelectList],
    props: {
      param: {
        type: Object,
        default: () => {
          ...
          fields: [
            {
              ...
              className: 'link',
              onClick: (item) => {
                self.$router.push({name: 'detailloadbalancer', params: {uuid: item.uuid}})
              },
              sortable: true,
              tooltip: true
            },
