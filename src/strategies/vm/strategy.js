...
export default {
  ...
  canMigrate (vm, psTable, globalLiveMigrate) {
    ...
    let rootVolumePsType = _.get(psTable, `${rootVolume.primaryStorageUuid}.type`);// billing page
  ...
  canChangeConfig (vm, isNumaEnabled) {
    // http://gitlab.zstack.io/zstackio/zstack-ui-doc/blob/master/%E4%BA%91%E4%B8%BB%E6%9C%BA/%E4%BF%AE%E6%94%B9%E8%AE%A1%E7%AE%97%E8%A7%84%E6%A0%BC.md
    const actions = new Map([
