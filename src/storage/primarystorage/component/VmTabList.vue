  ...
  <div class="container">
    ...
    <div>
      <el-table
        ...
        <el-table-column :label="$t('common.defaultIp')" prop="defaultL3NetworkIp">
  ...
  export default {
    ...
    methods: {
      ...
      getCondition: function () {
        let conditionList = []
        conditionList.push(`rootVolume.primaryStorage.uuid=${this.param.primaryStorageUuid}`)
