...
<script>
  ...
  export default {
      ...
      return {
        ...
        dataSource: {
          ...
          fields: [
            ...
            {
              getContent: item => self.getField('storageType', item),
              getHeaderContent: self.$t('common.storageType'),
              sortable: true,
              tooltip: true,
              field: 'storageType'
            },
    ...
    methods: {
      ...
      //填充表格数据
      getField(field, item) {
        let self = this, normalFields = ['name', 'storageType', 'protocol'];
      ...
      goToCreate() {
        let self = this;
        self.$router.push({name:'createHybridAliCloudFileSystem'})
      }
    }
  }
</script>
