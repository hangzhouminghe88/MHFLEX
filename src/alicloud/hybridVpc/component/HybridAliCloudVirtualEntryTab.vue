        ...
        <drop-down class="detail-dropdown">
          ...
          <span slot="content">
            <div class="dropdown-content">
              ...
              <a style="padding-bottom: 12px;" :class="{'disabled-text': !isSelected || !canBatchDeleteEntry()}"
                 @click="isSelected && canBatchDeleteEntry() && pageDelete('router')">
                {{$t('common.destroy')}}
              </a>
            </div>
          </span>
...
<script>
  import HybridVirtualRouterEntryList from 'src/alicloud/hybridAliCloudVirtualrouterEntry/List';
  ...
  export default {
    name: "HybridAliCloudVirtualEntryTab",

    mixins: [MultiSelectList, PageBase, WindowBase, HybridVirtualRouterEntryList],
    ...
    methods: {
      ...
      goToCreate() {
        let self = this;
        self.detailAliCloudVpc.createEntryParam = {
          vRouterType: 'vrouter',
          ok: (param) => {
            let obj = {
              params: {
        ...
        self.detailAliCloudVpc.showCreateEntry = true;
      }
    }
  }
</script>
