  ...
  <div class="container">
    <div class="detail-page-toolbar">
      <div class="detail-page-toolbar-left">
        <span class="detail-page-toolbar-title" style="margin-right: 30px;">{{$t('common.hybridvpcvpngateway') + $t('common.colon')}}</span>
...
<script>
  ...
  import HybridVpcGatewayList from '../../hybridVpcGateway/List';
  import { formatDatetime } from '../../../utils/utils';
  import WindowBase from '../../../windows/Window';
  import PageBase from '../../../windows/PageBase';
  import _ from 'lodash'

  export default {
    name: "HybridAliCloudVpcGatewayTab",

    mixins: [HybridVpcGatewayList, PageBase, WindowBase, MultiSelectList],
    props: {
      param: {
        type: Object,
        default: () => {
          ...
          fields: [
            {
              ...
              onClick: (item) => {
                self.$router.push({name: 'detailHybridAliCloudVpcVpnGateway', params: {uuid: item.uuid}})
              },
              className: 'link',
              field: 'name'
            },
            {
              ...
              getHeaderContent: self.$t('hybridvpcvpngateway.ip'),
              sortable: true,
              tooltip: true,
              field: 'publicIp'
            },
