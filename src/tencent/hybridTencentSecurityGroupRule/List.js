...
export default {
  ...
  computed: {
    ...mapGetters({
      getList: 'hybridTencentSecurityGroupRule/getList'
    }),
  },
  ...
  methods: {
    ...
    queryList() {
      ...
      return self.dispatchAction('hybridTencentSecurityGroupRule/basicQuery', {
    ...
    pageDelete() {
      ...
      self.openDialog('ConfirmDlg', {
        ...
        uuidList,
        getName: (uuid) => {
          return self.dbData.hybridTencentSecurityGroupRule[uuid].cidrIp;
        },
        ok: () => {
