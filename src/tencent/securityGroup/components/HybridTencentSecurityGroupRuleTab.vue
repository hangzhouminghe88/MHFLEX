...
import HybridTencentSGRList from  'src/tencent/hybridTencentSecurityGroupRule/List';
...
export default {
	name: 'HybridTencentSecurityGroupRuleTab',

	mixins: [HybridTencentSGRList, WindowBase, MultiSelectList, PageBase],
      ...
      return {
        ...
        dataSource: {
          ...
          fields: [
            ...
            {
              getContent: item => self.getField('lastOpDate', item),
              getHeaderContent: self.$t('common.lastOpDate'),
              field: 'lastOpDate',
              tooltip: true,
              sortable: true
            }
    ...
    methods: {
      ...
      getField(field, item) {
        ...
        if(field === 'lastOpDate') return formatDatetime(new Date(item[field]));
      },
