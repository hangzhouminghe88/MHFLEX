...
<script>
  import HybridAliCloudSwitchList from 'src/alicloud/hybridSwitch/List';
  ...
  export default {
    ...
    mixins: [WindowBase, HybridAliCloudSwitchList, MultiSelectList],
    ...
    methods: {
      ...
      getField(field, item) {
        ...
        if(field === 'vpc') return self.getVpcName(item.ecsVpcUuid).replace(/-ZStack/g, '');
