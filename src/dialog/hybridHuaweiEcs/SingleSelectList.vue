<template>
    <dialog-template>
      <div slot="title" class="modal-plain-header">
        <span class="dialog-title">选择华为云Ecs</span>
        <span class="dialog-close el-icon-close" @click="close()"></span>
      </div>
      <div slot="body" class="dialog-body" style="padding: 20px 20px">
...
<script>
    ...
    import HuaweiEcsList from 'src/huaweicloud/ecsInstance/List';

    export default {
      name: "SingleSelectList",
      mixins: [MultiSelectList, WindowBase, HuaweiEcsList],
      data() {
        let self = this;
        return {
