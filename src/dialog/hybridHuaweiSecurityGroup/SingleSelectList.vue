<template>
    <dialog-template>
      <div slot="title" class="modal-plain-header">
        <span class="title">选择华为云安全组</span>
...
<script>
  import HybridTencentSecurityGroupList from 'src/huaweicloud/securityGroup/List';
  ...
  import _ from 'lodash';
    ...
    export default {
      mixins: [WindowBase, MultiSelectList, HybridTencentSecurityGroupList],
      ...
      methods: {
        ...
        getField (field, item) {
          let  normalFields=['name', 'securityGroupId', 'dataCenterName'];
