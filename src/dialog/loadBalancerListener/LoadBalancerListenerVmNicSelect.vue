    ...
    <div slot="body">
      <div style="padding: 10px 20px">
        ...
        <div class="page-table">
          <mh-table :data-source="dataSource" :type="type"></mh-table>
...
<script>
  ...
  export default {
    name: "LoadBalancerListenerVmNicSelect",
    ...
    data(){
      ...
      return {
        ...
        dataSource:{
          ...
          handleSingleSelect: self.select,
    ...
    methods: {
      ...
      confirm() {
        ...
        if(self.dialogData.param.ok && self.dialogData.param.type === 'radio'){
        ...
        if(self.dialogData.param.select && self.dialogData.param.type === 'selection'){
          ...
          this.dialogData.param.select(self.selectedList)
          this.cancel()
        }
      },
      select(row) {
