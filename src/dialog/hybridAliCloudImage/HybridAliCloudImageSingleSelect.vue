...
<script>
  import HybridAliCloudImageList from 'src/alicloud/hybridImage/List';
  ...
  export default {
    name: 'HybridAliCloudImageSingleSelect',

    mixins: [WindowBase, HybridAliCloudImageList, MultiSelectList],
    ...
    methods: {
      ...
      getField(field, item) {
        let normalFields = ['name', 'platform', 'type', 'ecsImageId', 'dataCenterName'];
