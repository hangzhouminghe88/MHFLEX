...
<script>
import HybridTencentSecurityList from 'src/tencent/securityGroup/List';
...
export default {
	name: 'HybridTencentSingleSelect',

	mixins: [WindowBase, MultiSelectList, HybridTencentSecurityList],
