...
<script>
  import HybridVRList from 'src/alicloud/hybridVirtualRouter/List';
  ...
  export default {
    ...
    mixins: [WindowBase, HybridVRList, MultiSelectList],
      ...
      return {
        ...
        dataSource: {
          ...
          fields: [
            ...
            {
              getContent: item => self.getField('virtualrouterId', item),
    ...
    methods: {
      ...
      getField(field, item) {
        let self = this, normalFields = ['name', 'virtualrouterId', 'vpcName'];
