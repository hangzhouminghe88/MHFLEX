...
<script>
  import hybridConnAccessPointList from 'src/alicloud/hybridAliCloudAccessPoint/List';
  ...
  export default {
    ...
    mixins: [WindowBase, hybridConnAccessPointList, MultiSelectList],
      ...
      return {
        ...
        dataSource: {
          ...
          fields: [
            ...
            {
              getContent: item => self.getField('hostOperator', item),
              getHeaderContent: self.$t('hybridconnectionaccesspoint.hostOperator'),
              sortable: true,
              tooltip: true,
              field: 'vbrId'
            },
            {
              ...
              getHeaderContent: self.$t('hybridconnectionaccesspoint.type'),
              sortable: true,
              tooltip: true,
              field: 'physicalConnectionId'
            },
            {
              getContent: item => self.getField('accessPointId', item),
              getHeaderContent: self.$t('hybridconnectionaccesspoint.accessPointId'),
              sortable: true,
              tooltip: true,
            ...
            },
            {
              ...
              getHeaderContent: self.$t('hybridconnectionaccesspoint.datacenter'),
              sortable: true,
              tooltip: true,
            ...
            },
            {
              ...
              getHeaderContent: self.$t('hybridconnectionaccesspoint.status'),
              sortable: true,
              tooltip: true,
              field: 'status'
            },
    ...
    methods: {
      ...
      getField(field, item) {
        let self = this, normalFields = ['name', 'hostOperator', 'type', 'accessPointId', 'status', 'dataCenterName'];
