...
<script>
  import AliInstanceOfferingList from 'src/alicloud/hybridInstanceOffering/List';
  ...
  export default {
    ...
    mixins: [AliInstanceOfferingList, MultiSelectList, WindowBase],
    ...
    data() {
      ...
      return {
        ...
        dataSource: {
          ...
          fields: [
            {
              getContent: item => self.getField('typeId', item),
            ...
            {
              getContent: item => self.getField('generation', item),
              getHeaderContent: self.$t('hybridEcsInstanceType.generation'),
              field: 'generation'
            },
            {
              getContent: item => self.getField('typeFamily', item),
    ...
    methods: {
      ...
      getField(field, item) {
        let normalFields = ['typeId', 'cpu', 'generation', 'typeFamily'];
