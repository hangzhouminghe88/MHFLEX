<template>
  <dialog-template>
    <div slot="title" class="modal-plain-header">
      <span class="modal-title">{{$t('hybridvpcvpngateway.select')}}</span>
...
<script>
  import VpnGatewayList from 'src/alicloud/hybridVpcGateway/List';
  ...
  export default {
    ...
    mixins: [WindowBase, VpnGatewayList, MultiSelectList],
