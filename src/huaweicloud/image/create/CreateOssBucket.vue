<template>
  <create-template-no-reoute class="create_oss_container">
     <div
      slot="header"
    >
     ...
     <div slot="body" class="create-body">
      <mh-input type="slot" :label="'添加方式'">
          <el-radio-group v-model="isCreate">
...
export default {
   ...
   mixins: [WindowBase],
   components: {
     'create-template-no-reoute': CreateTemplateNoRoute,
     AddOrDeleteInput
   },
   props: {
     param: {
